    ...
    return (
        ...
        <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-3 text-white min-vh-100">
            <a href="/" className="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                <span className="fs-4 fw-bold d-none d-sm-inline">Menu</span>
            </a>
            <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start w-100" id="menu">
                <IndexComponent url="/" name="Trang chủ" icon={<SpaceDashboardIcon />} activeURL={current} />
                <IndexComponent url="/bills" name="Hóa đơn" icon={<ReceiptIcon />} activeURL={current} />
                <IndexComponent url="/live-scale" name="Cân trực tiếp" icon={<ScaleIcon />} activeURL={current} />
                <IndexComponent url="/fruits" name="Danh mục trái cây" icon={<CategoryIcon />} activeURL={current} />
            </ul>
            <div className="mt-auto w-100">
                <div className="dropdown pb-4">
                    <a href="#" className="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <span className="d-none d-sm-inline mx-1">Chúa tể trái cây</span>
                    </a>
                </div>
            </div>
        </div>
